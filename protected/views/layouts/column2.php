		...
		<?php
			...
			if (Yii::app()->user->rol == 'Alumno'){
				$menu = array(
						...
						array('label'=>'Ver solicitudes de cartas de recomendación', 'url'=>array('solicitudCartaRecomendacion/index')),
			...
			//Si es empleado
				...
				$menu = array(
					...
					array('label'=>'Ver solicitudes de cartas de recomendación', 'url'=>array('solicitudCartaRecomendacion/index')),
					array('label'=>'Ver solicitudes de revalidación de materias', 'url'=>array('solicitudRevalidacion/index')),
					array('label'=>''),
					array('label'=>''),
